---
layout: page
title: Повірка та юстирування в Харкові
icon: /assets/img/icons/size.png
ref: spec-design
lang: ua
description: Ми проектували габарити наших вагів так, щоб вони чітко відповідали розмірам вимірювальних апаратів в Харківському центрі метрології, що полегшує процес что облегчает процесс повірки та юстирування та робить його більш доступним!
---
<!-- 
<div class="row">
    <div class="col-md-12">
