---
layout: page
title: Найкращі комплектуючі
icon: /assets/img/icons/layers.svg
ref: materials
lang: ua
description: Ми використовуємо лише комплектуючі найкращих світових виробників (Kingbright, Analog Devices, Atmel, Vishay). На кожному етапі виробництва та відправлення ми проводимо повний цикл технологічних та кліматичних іспитів.
---
<!-- 
<div class="row">
    <div class="col-md-12">
